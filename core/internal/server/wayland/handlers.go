...
func handleICCGetStatus(conn net.Conn, req models.Request, manager *Manager) {
...
func handleICCApply(conn net.Conn, req models.Request, manager *Manager) {
...
func handleICCRemove(conn net.Conn, req models.Request, manager *Manager) {
	output, err := params.String(req.Params, "output")
	if err != nil {
		models.RespondError(conn, req.ID, err.Error())
		return
...
func handleICCListOutputs(conn net.Conn, req models.Request, manager *Manager) {
	outputs := manager.ListOutputs()
	models.Respond(conn, req.ID, outputs)
}

func handleICCSetTemp(conn net.Conn, req models.Request, manager *Manager) {
	output, err := params.String(req.Params, "output")
	if err != nil {
		models.RespondError(conn, req.ID, err.Error())
		return
...
func handleICCGetTemps(conn net.Conn, req models.Request, manager *Manager) {
